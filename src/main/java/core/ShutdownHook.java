...
public class ShutdownHook extends Thread {
    ...
    @Override
    public void run() {
        System.out.println("Shutting down customer service...");
        ...
        try {
            ...
            System.out.println("Error while shutting down customer service.");
            System.out.println(e.toString());
        }

        System.out.println("Customer service successfully shut down.");
    }
}